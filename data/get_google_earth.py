"""
SOURCE: https://stackoverflow.com/questions/7490491/capture-embedded-google-map-image-with-python-without-using-a-browser
...
def get_maps_image(NW_lat_long, SE_lat_long, zoom=18):
    ...
    print("total image dim = {}, {}".format(dx, dy))
    print("and max size dim = {}, {}".format(MAXSIZE, MAXSIZE))
    print()
...
if __name__ == '__main__':
    # TL and BR corresponding to settlement at (6.43926, 3.348013)
    NW_lat_long =  (6.434356*DEGREE, 3.378694*DEGREE)
    SE_lat_long = (6.430337*DEGREE, 3.383869*DEGREE)
...
#    url = 'http://maps.google.com/maps/api/staticmap'
#    urlparams = get_maps_image(NW_lat_long, SE_lat_long, zoom=zoom)
#   urlparams = {
#                     'center': "6.425872,3.359829",
#                     'zoom': "18",
#                     'size': "400x400",
#                     'maptype': 'satellite',
#                     'sensor': 'false',
