...
def build_training_data(pic_size, step_size, class_threshold, 
    ...
    output_path = "training_data/descartes"
    ...
    ona_images_masks = os.listdir(mask_path)
    ona_images_slums = os.listdir(slum_image_path)
    ona_images = [f for f in ona_images_masks if f in ona_images_slums]
...
if __name__ == "__main__":
    ...
    slum_image_path = "descartes/RGB/slums"
    nonslum_image_path = "descartes/RGB/not_slums"
