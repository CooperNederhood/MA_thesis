...
MODEL_NAME = "dil_net"
MODEL_DETAILS = '''Load weights from VGG-16 TRAINED convolutional base.
Then, add a context model on top of that. Fix the VGG-16 weights.
Context model has 6 layers
'''

VGG_TRAIN = False 

# Model def is still here tho, rather than dil_alt0
...
FRONT_END_TYPE = "vgg_tuned" 
PATH_TO_FRONT_END_WEIGHTS = "../dil_alt0/dil_net_front" 
...
# test_eval.do_in_sample_tests(net, "../../..")